		...
		$scope.pdf_export = function() {
			html2canvas($('#charts')[0], {
				onrendered: function(canvas) {
					...
					doc.addImage(logo_png_white, 'PNG', 30, 200, 150, 26);
